...
var path = require('path'),
    ...
    mapDictionaryValue = require('./mapDictionaryValue'),
...
function buildFile(file = {}, platform = {}, dictionary = {}) {
  var { destination, filter, format, valueField } = file || {};
  ...
  const mappedDictionary = mapDictionaryValue(dictionary, valueField, platform)
  const filteredProperties = filterProperties(mappedDictionary, filter);
  const filteredDictionary = Object.assign({}, mappedDictionary, {
    ...
    // keep the unfiltered, unmapped properties object for reference resolution
